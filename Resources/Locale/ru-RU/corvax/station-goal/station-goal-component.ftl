...
station-goal-training = 
    NT-CC-CMD-GOL
    Цель вашей смены проведение регулярных учебных упражнений, чтобы обеспечить готовность экипажа к любой аварийной ситуации.
    Главам отделов необходимо провести тестирование на профессиональную пригодность. 
    Службе безопасности необходимо провести учения по стрельбе и задержанию преступников.
