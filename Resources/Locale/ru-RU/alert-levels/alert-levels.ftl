...
alert-level-red-instructions = Члены экипажа должны найти безопасное место для укрытия, и им рекомендуется следовать любым существующим властям.
...
alert-level-gamma-instructions = Все гражданские должны немедленно найти ближайшего главу для транспортировки в безопасное место.
